...
DEFAULT_UNIVERSE: List[str] = ["ZC=F"]
...
# ──────────────────────────────────────────────
# Early Season and Yield Model
# ──────────────────────────────────────────────
PREDICTION_YEAR = 2026

# april, may, june, july, august, september
PREDICTION_STAGE = "april"
...
BUY_THRESHOLD  =  0.0025         #  +0.25 % predicted upside → buy
SELL_THRESHOLD = -0.0025         # -0.25 % predicted downside → sell
...
# --------------------------------
# FUNDAMENTAL STRATEGY SETTINGS
# --------------------------------

# Yield revision thresholds
# Example:
# previous = 181
# current  = 177
# revision = -4

YIELD_BULLISH_REVISION = -2.0
YIELD_BEARISH_REVISION = 2.0

# Drought threshold
DROUGHT_INDEX_THRESHOLD = 8.0
