...
Usage:
    python main.py backtest                          # single-asset (AAPL)
    python main.py backtest --universe AAPL MSFT GOOGL
...
def build_parser() -> argparse.ArgumentParser:
    ...
    bt.add_argument(
        ...
        help="Tickers to trade (default: AAPL). Example: --universe AAPL MSFT NVDA",
    )
